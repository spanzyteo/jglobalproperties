/**
 * Shared form utilities for land management
 * Located at: app/(admin)/admin/lands/features/formUtils.ts
 */

import { ImageDetail, Unit, LandFormData } from "./types";

/**
 * Build FormData from land form data for API submission
 */
