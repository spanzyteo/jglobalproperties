...
const Navbar = () => {
  return (
    <div className="flex h-[4.1875rem] lg:h-[7.5rem] p-4 lg:py-[1.25rem] lg:px-[5rem] justify-center flex-col gap-[0.625rem] bg-[#FFF] fixed w-full top-0 z-50">
      <div className="flex justify-between items-center">
        ...
        />
        <IoMdMenu className="w-[3rem] h-[3rem] lg:hidden" />
