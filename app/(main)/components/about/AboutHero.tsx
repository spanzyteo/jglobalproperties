  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full min-h-[500px] md:min-h-[600px] lg:min-h-[600px] text-white gap-8 md:gap-10 px-5">
          <h1
