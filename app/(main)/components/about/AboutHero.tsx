  ...
  return (
    <>
      <Parallax
        ...
        className="relative min-h-[500px] md:min-h-[600px] lg:min-h-[717px]"
      >
        <div className="absolute inset-0 bg-gradient-to-b from-[#111111]/60 via-[#111111]/70 to-[#111111]/80 z-0" />
        <div className="relative z-10 flex flex-col items-center justify-center h-full min-h-[500px] md:min-h-[600px] lg:min-h-[717px] text-white gap-8 md:gap-10 px-5">
          <h1
